  ...
  },
  {
    ...
    topics: [
      ...
      topic("Performance Portfolio", "Stage time, documented.",
        ...
        { type: "image", src: "/photo-hulahoop.jpg", caption: "Stage Performance — Band-it Festival" }),
      ...
      topic("Voice & Screen", "Voice acting and dubbing.",
        ...
        { type: "image", src: "/tv-dubbing.png", caption: "Dubbing Session — Veere Di Wedding · Hindi Medium" }),
