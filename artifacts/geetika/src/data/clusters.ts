...
export const CLUSTERS: Cluster[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      topic("Awards Archive", "Every ribbon, every certificate.", "Academic competitions, olympiad placements, honor rolls, and subject awards — catalogued with context, not just titles. Each award tells a story about what was happening when it was earned."),
